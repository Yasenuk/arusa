...
export default function Articles() {
	const articleTitle = "Манхеттен Піа-терре для нової квартири в Чикаго";
			...
			<div className={styles.articles__container}>
				...
				<div className={styles.articles__wrap}>
					<div className={styles.articles__content}>
						<h3 className={`${styles['articles__content-title']} h h_l`}>{articleTitle}</h3>
						...
						<Link
							to="/blog"
							aria-label={`Читати статтю: ${articleTitle}`}
							className={`${styles.articles__button} small _button _button_article no-inline upper`}>
							Читати статтю
						</Link>
					</div>
					<picture>
						...
						<img loading="lazy" className={styles.articles__picture} width="664" height="561" src="/assets/images/articles/manhattan-chicago-apartment-living-room.png" alt="Вітальня у стилі манхеттенського апартаменту з яскравим декором" />
					</picture>
				</div>
				<Link to="/blog" className={`${styles.articles__button} small _button _button_article no-inline upper`}>Переглянути всі статті</Link>
